...
const Pagination = ({ page, count }: { page: number; count: number }) => {
  ...
  console.log("Pagination component rendered with page:", page, "and count:", count);
  return (
    <div className="p-4 flex items-center justify-between text-gray-500">
      ...
      {Array.from(
          ...
          (_, index) => {
            ...
            console.log("Rendering page button for pageIndex:", pageIndex);
            return (
              <button
                key={pageIndex}
                className={`px-2 rounded-sm ${
                  page === pageIndex ? "bg-sky-200" : ""
                }`}
                onClick={() => {
